/**
 * Official 2-10 Home Buyers Warranty Guidelines
 * Source: US_W.DS.Sv2_11_2023
 * 
 * This data is used by both:
 * - Admin warranty review tool (with section citations)
 * - Homeowner coverage preview (educational, no citations)
 */

export const WARRANTY_GUIDELINES = `
