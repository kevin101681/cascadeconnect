        ...
        <Card title="Profit & Loss Statement" className="min-h-[500px]">
          <div className="mt-4 space-y-8">
            ...
            <div>
              ...
              <div className="flex justify-between items-center py-3 bg-secondary text-onSecondary px-4 rounded-lg"><span className="font-bold">Total Income</span><span className="font-bold">${filteredData.totalIncome.toFixed(0)}</span></div>
            </div>
            <div>
              ...
              <div className="flex justify-between items-center py-3 bg-secondary text-onSecondary px-4 rounded-lg"><span className="font-bold">Total Expenses</span><span className="font-bold">${filteredData.totalExpenses.toFixed(0)}</span></div>
            </div>
