  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
           ...
           <div>
            ...
            <div className="mt-1 flex flex-col items-center justify-center px-6 pt-5 pb-6 border-2 border-surface-outline-variant border-dashed rounded-xl hover:bg-surface-container transition-colors">
                ...
                <p className="text-xs text-surface-outline-variant mt-1">Images, Videos, PDFs</p>
            </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                {attachments.map(att => (
                  <div key={att.id} className="relative group bg-surface-container border border-surface-outline-variant rounded-lg p-2 flex items-center gap-3">
                    ...
                    <span className="text-xs truncate flex-1 font-medium text-surface-on">{att.name}</span>
      ...
      <div className="flex justify-end space-x-3 pt-6 border-t border-surface-outline-variant">
        ...
        <Button type="submit" variant="filled">Create Claim</Button>
      </div>
    </form>
  );
};
